package com.monetware.pdexperiment.system.util.word;
...
public class WordExport {
    ...
    public static String exportWord(Map<String, Object> params,String templatePath,String filePath,String fileName){
        ...
        try {
            ...
            String goalName=filePath+File.separator+fileName;
    ...
    public static void main(String[] args) {
        ...
        image.setHeight(200);
        image.setWidth(200);
        image.setUrl("G:/imgs/2010.jpg");
        image.setType(WordImageEntity.URL);

        Map<String,Object> map=new HashMap<>();
        map.put("task_purpose","aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
        map.put("imgs",image);
        map.put("auth","帅无敌");
        map.put("registerNum","123456789");
        map.put("data","12456789");
        map.put("result","124567899999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999");
        map.put("result1","1245678999999999999999999999999999999999999999999999999999999999999999999999999999999999");
        String s = exportWord(map,"G:/imgs/23.docx","E:/aa","52.docx");
    }
